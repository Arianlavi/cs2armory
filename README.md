...
<p align="center">
  ...
  <img src="https://img.shields.io/github/downloads/Arianlavi/cs2armory/CS2Armory.zip?style=for-the-badge&label=Downloads&color=FFC107" alt="Downloads">
...
#### Prebuilt Executable
1. Download the latest version from the **[Releases](https://github.com/Arianlavi/cs2armory/releases/)** page.
...
۱. اخرین نسخه برنامه را از صفحه **[Releases](https://github.com/Arianlavi/cs2armory/releases/)** دانلود کنید.
...
1. Скачайте последнюю версию программы со страницы **[Releases](https://github.com/Arianlavi/cs2armory/releases/)**.
